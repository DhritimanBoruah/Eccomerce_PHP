        ...
        <div class="text-center mt-3 pt-5 col-lg-6 col-md-12 col-sm-12">
            <form action="account.php" id="account-form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="cpassword" id="account-password-confirm" placeholder="Confirm Password">
                </div>
                <div class="form-group">
                    <input type="submit" class="btn" name="change_password" id="change-pass-btn" value="Change Password">
                </div>
            </form>
                ...
                <tr>
                    ...
                    <td>
                        <form action="order_details.php" method="GET">
                            ...
                            <input type="submit" class="btn" value="Order Details" name="order_details_btn" style="width:auto;padding:2px;margin:10px;background-color:coral;color:white;">
                        </form>
                    </td>
                </tr>
