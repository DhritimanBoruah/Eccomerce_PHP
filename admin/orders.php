...
$stmt2 = $conn->prepare("SELECT o.*, u.user_name, u.phone_number, u.shipping_address FROM orders o LEFT JOIN users u ON o.user_id = u.user_id LIMIT ?, ?  ");
                        ...
                        <tbody>
                            <?php foreach ($orders as $order) { ?>
                                <tr>
                                    ...
                                    <td><a href="order_view.php?order_id=<?= $order['order_id']; ?>" class="btn btn-secondary">View</a></td>
