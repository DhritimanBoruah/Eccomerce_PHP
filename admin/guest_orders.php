...
$stmt2 = $conn->prepare("SELECT o.*, u.user_name, u.phone_number, u.shipping_address FROM orders o LEFT JOIN users u ON o.user_id = u.user_id WHERE u.is_guest=1 LIMIT ?, ?  ");
